 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|ReviewSubmissionAction whereActorUserId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|ReviewSubmissionAction whereActorUserRole($value)
 *
 * @mixin \Eloquent
 */
class ReviewSubmissionAction extends Model {
    ...
    // TODO: created while implementing ReviewSubmissionController::store() - decide if wanted
    // if we create a `ReviewSubmission::addAction()` method, can we remove this $fillable?
    protected $fillable = [
        'actor_user_id',
        'actor_user_role',
        'type',
